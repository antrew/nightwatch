...
class MatcherExclude {
  constructor(filterPattern, src_folders = []) {
...
class FilenameMatcher {
  ...
  static create(filterPattern, src_folders) {
    return new MatcherExclude(filterPattern, src_folders);
  }
  ...
  static addMatcher(type, pattern, src_folders) {
    let matcher = FilenameMatcher.create(pattern, src_folders);
