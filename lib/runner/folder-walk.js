...
class Walk {
  ...
  registerMatchers() {
    ...
    if (this.settings.exclude) {
      FilenameMatcher.addMatcher(FilenameMatcher.TYPE_EXCLUDE, this.settings.exclude, this.testSource);
    }

    if (this.settings.filter) {
      FilenameMatcher.addMatcher(FilenameMatcher.TYPE_FILTER, this.settings.filter, this.testSource);
    }
  }
